...
Tokens, which are sent out by the server, are strings of cryptic texts that can be stored on the client side for future data transfers.

2. What steps can you take in your web apps to keep your data secure?

Some steps you can take in making web applications to make them more secure is to add Private Routes which only certain users can access. Also JWT help in the aspect that no one can receive and send data without the token matching on the back end.

3. Describe how web servers work.

You make a request from your browse which goes through your Modem/ISP allowing you to access servers on the World Wide Web by the domain you typed in. These servers communicate with each other.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create - Appends data to the API
Read - Gets data from the API.
